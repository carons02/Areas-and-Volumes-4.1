...
namespace TrapezoidAreaDLL
{
    public class TrapezoidAreaFormula
    {
        ...
        public decimal Processchoice(decimal largeside, decimal smallside, decimal height, decimal area)
        {
